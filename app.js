...
var _this = this;
var API_URL = "https://6716c8003fcb11b265d397f4.mockapi.io";
var API_ENDPOINT = "".concat(API_URL, "/form");
...
function markFieldAsInvalid(field) {
    ...
    field.setAttribute("placeholder", "".concat(field.getAttribute("field-type"), " is Required"));
}
...
form.addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
    var isFormValid, formData, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                e.preventDefault();
                isFormValid = validateForm();
                if (!isFormValid) return [3 /*break*/, 4];
                formData = {
